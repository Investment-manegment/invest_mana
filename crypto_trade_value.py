...
def etl(schema, table):
    ...
    data_trade_val = sorted(ticker_data.items(), key=lambda item: float(item[1]['acc_trade_value_24H']), reverse=True)[:10]
    ...
    for k, v in json_data_trade_val.items():
        trade_val.append("('{}',{},{},{},{})".format(k, v["max_price"], v["min_price"], v["units_traded"], v["acc_trade_value"]))
